...
我们在[前面](https://guozheng.dev/writings/deploy-an-agent-with-python/)动手搭建了一个可以运行的智能体（Agent），它通过调用 wttr.in、Tavily 以及 DeepSeek 的 API，进而逐步实现天气查询、旅游景点推荐以及根据需求调用 LLM 的功能。
...
（1）环境（2）传感器（3）执行器（4）自主（5）行动（6）实体
...
- CrewAI. n.d. “[CrewAI Documentation](https://docs.crewai.com/).” 访问于 2026 年 5 月 16 日.
...
- LangChain. n.d. “[Graph API Overview](https://docs.langchain.com/oss/python/langgraph/graph-api).” 访问于 2026 年 5 月 16 日.
