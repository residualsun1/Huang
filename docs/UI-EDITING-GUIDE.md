...
5. 修改项目卡片外观：在 `public/styles.css` 搜索 `.project-grid`、`.project-card`、`.project-card::before`、`.status-dot` 和 `.project-card-actions`；卡片纸纹文件位于 `public/images/project-card-paper.webp`。
